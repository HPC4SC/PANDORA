...
MainWindow::MainWindow() : _display2D(0), _agentTypeSelection(0), _agentTraitSelection(0), _rasterSelection(0), _genericStatistics(0), _viewedStep(0), _progressBar(0)//, _windowRaster(true)*/
{ 
