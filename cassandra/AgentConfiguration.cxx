...
AgentConfiguration::AgentConfiguration() : _color(rand_r()%256,rand_r()%256,rand_r()%256), _icon(0), _useIcon(false), _fileName2D(""), _size(1.0f), _size3D(1.0f, 1.0f, 1.0f), _fileName3D(""), _model(0), _showValue(false)
{ 
    _color = QColor::fromHsv(rand_r() % 256, 255, 190);
