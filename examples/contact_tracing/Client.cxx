...
Client::Client(const std::string& id, const double& infectiousness, const int& sick, const float& purchaseSpeed, const float& stopping, const int& stopTime, 
    ...
    : HumanBeeing(id,infectiousness,sick,encounterRadius,phoneT1,phoneT2,phoneApp,signalRadius), _purchaseFinished(false), _itemsPurchased(0), _itemsPayed(0), _purchaseSpeedFactor(purchaseSpeed),
