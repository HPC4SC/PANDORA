...
class Bug : public Engine::Agent
{
	...
	Engine::Point2D<int> _pointyNipple; // MpiBasicAttribute
	std::string _pointyNoNipple;	// MpiBasicAttribute

	std::vector< char > _hey1;					// MpiComplexAttribute
	std::queue<char > _hey2;					// MpiComplexAttribute
	std::map<char, char> _hey3; 	// MpiComplexAttribute
...
public:
	...
	void setPointyNipple(const Engine::Point2D<int>& pointyNipple);
	void setPointyNoNipple(const std::string& pointyNoNipple);
...
private:
	...
	Engine::Point2D<int> _discrete_pointyNipple;
	int _discrete_maxConsumptionRate;
	int _discrete_size;
	int _discrete_maxBugMovement;
	std::string _discrete_pointyNoNipple;

	void* _deltaPackage;

	std::vector<char> _discrete_hey1;
	std::queue<char> _discrete_hey2;
	std::map<char,char> _discrete_hey3;
	///////// End of autogenerated code ///////////


	///// Autogenerated code (do not modify): /////
private:
	std::vector<std::tuple<int, int, char>> _deltaFor_hey1;			// <typeOfModification, elementIndex, elementNewValue>
	std::vector<std::tuple<int, char>> _deltaFor_hey2;			// <typeOfModification, elementNewValue>
	std::vector<std::tuple<int, char, char>> _deltaFor_hey3;			// <typeOfModification, elementKey, elementValue>

public:
	void insertElementAtIndex_hey1(const char& element, const int& index);
	void updateElementAtIndex_hey1(const char& element, const int& index);
	void deleteElementAtIndex_hey1(const int& index);
	void pushElement_hey2(const char& element);
	void popElement_hey2();
	void insertOrUpdateElement_hey3(const char& key, const char& value);
	void deleteElement_hey3(const char& key);
	///////// End of autogenerated code ///////////
