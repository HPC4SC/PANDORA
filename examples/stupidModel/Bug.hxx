...
private:
	...
	///// Autogenerated code (do not modify): /////
private:
	std::vector<std::tuple<int, int, Engine::Point2D<int>>> _deltaFor_hey3;
	std::vector<std::tuple<int, bool>> _deltaFor_hey2;
	std::vector<std::tuple<int, int, float>> _deltaFor_hey1;
