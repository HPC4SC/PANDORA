...
class Bug : public Engine::Agent
{
	...
	std::vector< std::string > _hey1;					// MpiComplexAttribute
	std::queue<std::string > _hey2;					// MpiComplexAttribute
	std::map<std::string, std::string> _hey3; 	// MpiComplexAttribute
...
private:
	...
	Engine::Point2D<int> _discretepointyNipple;

	void* _deltaPackage;

	std::vector<std::string> _discrete_hey1;
	std::queue<std::string> _discrete_hey2;
	std::map<std::string,std::string> _discrete_hey3;
	///////// End of autogenerated code ///////////


	///// Autogenerated code (do not modify): /////
private:
	std::vector<std::tuple<int, int, std::string>> _deltaFor_hey1;			// <typeOfModification, elementIndex, elementNewValue>
	std::vector<std::tuple<int, std::string>> _deltaFor_hey2;			// <typeOfModification, elementNewValue>
	std::vector<std::tuple<int, std::string, std::string>> _deltaFor_hey3;			// <typeOfModification, elementKey, elementValue>

public:
	void insertElementAtIndex_hey1(const std::string& element, const int& index);
	void updateElementAtIndex_hey1(const std::string& element, const int& index);
	void deleteElementAtIndex_hey1(const int& index);
	void pushElement_hey2(const std::string& element);
	void popElement_hey2();
	void insertOrUpdateElement_hey3(const std::string& key, const std::string& value);
	void deleteElement_hey3(const std::string& key);
	///////// End of autogenerated code ///////////
