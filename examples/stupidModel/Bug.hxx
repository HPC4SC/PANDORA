...
class Bug : public Engine::Agent
{
	...
	std::vector< Engine::Point2D<int> > _hey1;					// MpiComplexAttribute
	std::queue<Engine::Point2D<int> > _hey2;					// MpiComplexAttribute
	std::map<Engine::Point2D<int>, Engine::Point2D<int>> _hey3; 	// MpiComplexAttribute
...
private:
	...
	std::vector<Engine::Point2D<int>> _discrete_hey1;
	std::queue<Engine::Point2D<int>> _discrete_hey2;
	std::map<Engine::Point2D<int>,Engine::Point2D<int>> _discrete_hey3;
	///////// End of autogenerated code ///////////


	///// Autogenerated code (do not modify): /////
private:
	std::vector<std::tuple<int, int, Engine::Point2D<int>>> _deltaFor_hey1;			// <typeOfModification, elementIndex, elementNewValue>
	std::vector<std::tuple<int, Engine::Point2D<int>>> _deltaFor_hey2;			// <typeOfModification, elementNewValue>
	std::vector<std::tuple<int, Engine::Point2D<int>, Engine::Point2D<int>>> _deltaFor_hey3;			// <typeOfModification, elementKey, elementValue>

public:
	void insertElementAtIndex_hey1(const Engine::Point2D<int>& element, const int& index);
	void updateElementAtIndex_hey1(const Engine::Point2D<int>& element, const int& index);
	void deleteElementAtIndex_hey1(const int& index);
	void pushElement_hey2(const Engine::Point2D<int>& element);
	void popElement_hey2();
	void insertOrUpdateElement_hey3(const Engine::Point2D<int>& key, const Engine::Point2D<int>& value);
	void deleteElement_hey3(const Engine::Point2D<int>& key);
	///////// End of autogenerated code ///////////
